...
//     const shortendText = text.slice(i, i + chunk);
//     const audioURL = getAudio(shortendText);
...
`
const updatedText = text.slice(1,3000);
...
axios
    ...
    .then((response) => {
        console.log("Response Data AudioFile : "+response.data.audioFile);
        ...
        // audio.addEventListener('canplaythrough', (event) => {
            // audio.play();
        // })
        FileSaver.saveAs(response.data.audioFile,"audio1.mp3");   
    })
    .catch((error) => {
